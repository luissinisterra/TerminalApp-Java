...
public class VistaLogin extends javax.swing.JFrame {
    ...
    private void btnIniciarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIniciarSesionActionPerformed
        ...
        Usuario usuario = this.controladorPrincipal.iniciarSesion(documento, contrasena);
        boolean existeUsuario = usuario != null;

        if(existeUsuario){
            if(usuario instanceof AdministradorTerminal){
                VistaAdminTerminal vc = new VistaAdminTerminal(this.controladorPrincipal);
                vc.setVisible(true);
                this.dispose();
            }

            if(usuario instanceof AdministradorFlota){
                VistaAdminFlota vc = new VistaAdminFlota(this.controladorPrincipal, usuario);
                vc.setVisible(true);
                this.dispose();
            }
